...
2. Render a list of books that show the book title and book image in the Book List !check
3. Clicking on a book in the Book List should add it to the Bookshelf !check
4. Clicking on a book in the Bookshelf should remove it from the Bookshelf!check
